        ...
        public ActionResult CheckOut(OrderViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cart != null)
                {
                    ...
                    WebBanHangOnline.Common.Common.SendMail("Chát Quán", "Đơn hàng #" + order.Code, contentCustomer, order.Email);
                    ...
                    WebBanHangOnline.Common.Common.SendMail("Chát Quán", "Đơn hàng mới #" + order.Code, contentAdmin, ConfigurationManager.AppSettings["EmailAdmin"]);
                    cart.ClearCart();
