namespace WebBanHangOnline.Migrations
{
    ...
    public partial class ChangesData : DbMigration
    {
        public override void Up()
        {
            AlterColumn("dbo.tb_New", "Alias", c => c.String(maxLength: 250));
            AlterColumn("dbo.tb_New", "SeoTitle", c => c.String(maxLength: 250));
            AlterColumn("dbo.tb_New", "SeoDescription", c => c.String(maxLength: 500));
            AlterColumn("dbo.tb_New", "SeoKeywords", c => c.String(maxLength: 250));
